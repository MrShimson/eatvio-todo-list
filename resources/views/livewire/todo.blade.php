<li draggable="true" drag-item="{{ $todo['id'] }}" class="list-group-item border-0 rounded-3 pt-1 pb-0 mx-auto">
    <div class="d-inline-flex border rounded-3 my-1 ps-2 {{ $bgColorClass }}">
